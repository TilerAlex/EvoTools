...
set TEMP_DIR=%cd%\EvoTools

if exist "EvoTools.zip" (
    del "EvoTools.zip"
)
...
powershell -Command "Add-Type -A 'System.IO.Compression.FileSystem'; [IO.Compression.ZipFile]::CreateFromDirectory('EvoTools', 'EvoTools.zip')"

rmdir /S /Q "EvoTools"

echo Build complete: EvoTools.zip
pause